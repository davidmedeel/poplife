...
[_caja, ["<t color='#DF0101'>Eliminar mágicamente</t>",'if (player getVariable "PoliON") then {deleteVehicle (_this select 0)}', "", 1,false,true,"",""]] remoteexec ["ica_fnc_meteAccion",-2];
