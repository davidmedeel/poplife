...
0 spawn {
	...
	_cajas = [cajaopio12, cajaopio12_1, cajaopio13, cajaopio13_1, cajaopio14, cajaopio14_1, cajaopio14_2,
	cajaopio15, cajaopio16, cajaopio5, cajaopio6];
	...
	while {true} do {
		...
		{_x animate ["door1", 0]} forEach [contenedores4, contenedores5, contenedores6,contenedores1_1,contenedores1_2];
...
0 spawn {
	private ["_cajas", "_contenidoCajas"];
	_cajas = [cajacoca1, cajacoca2, cajacoca3,cajacoca2_1,cajacoca2_2];
	...
	while {true} do {
		...
		{_x animate ["door1", 0]} forEach [contenedores1, contenedores2, contenedores3,contenedores1_1,contenedores1_2];
