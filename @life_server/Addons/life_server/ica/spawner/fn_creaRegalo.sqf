...
[_caja, ["<t color=""#FFBF00"" size='1' shadow='1'>" +"Buscar componentes electrónicos",' ["componentes"] execVM "ica\spawner\busca.sqf"; ', "", 7,false,true,"",""]] remoteexec ["ica_fnc_meteAccion",-2];
