...
if (_param isEqualTo "compro") exitWith {
	...
	format ["%1 - (%2) ha comprado %6 por %3€ - Dinero en banco : %4€ - Dinero en mano %5€",	 profileName,
	(getPlayerUID player),
	_precio,
	pop_atmdin,
	pop_din,
	([_cosa] call ica_fnc_classtoname)] remoteExecCall ["A3Log", 2];
...
if (_param isEqualTo "vendo") exitWith {
	...
	format ["%1 - (%2) ha vendido %6 por %4€ - Dinero en banco : %4€ - Dinero en mano %5€",	 profileName,
	(getPlayerUID player),
	_precio,
	pop_atmdin,
	pop_din,
