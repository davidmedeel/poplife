...
switch (_param) do {
	// Compra
	case "Tienda general": { ["tf_anprc152","tf_anprc148jem","ToolKit","ItemGPS","Binocular","pop_note","pop_iphone","pop_nokia","pop_armariog","pop_vendas_c","ItemMap","pop_armariop","pop_portatil","pop_pico","pop_pala","pop_hacha","pop_Ganzua","pop_combustible","pop_linterna"]	};
	case "Tienda de taxista": { ["Binocular","ItemGPS","ToolKit"] };
	case "Paqueteria correos": { ["pop_correos"] };
	case "Tienda del periodista": { ["tf_anprc152","Press_Mic_AAN_F","Press_Cam_F","Press_Mic_CNN_F","ItemGPS","ToolKit","POPTV_Pop","H_Cap_press","V_Press_F"] };
	...
	case "super": { ["pop_combustible","pop_G_Chocolate","pop_G_Oreo","pop_G_Ahoy","pop_R_Pepsi","pop_R_Superstar","pop_R_Pepper","pop_H_Fresa"] };
	case "Economato": { ["pop_P_Clasica","pop_G_Chocolate","pop_R_Naranja","pop_pringles","pop_H_vainilla","pop_Ganzua","pop_combustible","tf_fadak","ToolKit","pop_note","pop_iphone","pop_nokia","ItemMap","ItemGPS"] };
	...
	case "Farmacia EMS": { ["tf_anprc152","pop_bisturi_item","pop_vendas","pop_vendas_c","NVGoggles","pop_morfina","pop_epinefrina","pop_tramadol","pop_desfibrilador","pop_bolsadesangre","pop_csi","POP_senal_stop_i","POP_senal_derecha_i","POP_senal_izquierda_i","POP_senal_estrechamiento_i","POP_senal_velocidad20_i","POP_senal_velocidad40_i","POP_banda_i","POP_tetrapodo_i","POP_tetrapodo_x3_i","POP_tetrapodo_x5_i","POP_tetrapodo_x7_i","POP_electroflare_i"] };
	case "Supermercado para polis": { ["pop_P_Oliva","pop_G_Oreo","pop_vendas_c","pop_kiwi","pop_R_7up","pop_portatil","pop_pringles","pop_llaves","pop_H_Napolitana","pop_Ganzua","pop_esposas","pop_combustible","tf_fadak","ToolKit","pop_note","pop_iphone","pop_nokia","ItemMap","ItemGPS"] };
	case "Tienda chunga": { ["tf_anprc152","pop_P_Originales","pop_G_Oreo","pop_R_monster","pop_pringles","pop_H_Napolitana","pop_vendas_c","tf_anprc148jem","pop_Ganzua","pop_portatil","pop_esposas","pop_llaves","pop_combustible","tf_anprc152","ToolKit","pop_note","pop_iphone","pop_nokia","ItemMap","ItemGPS"] };
