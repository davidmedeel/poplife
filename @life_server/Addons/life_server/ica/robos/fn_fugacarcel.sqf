...
if (_param isEqualTo "abropuertas") exitWith {
	...
	[_position] remoteexec ["life_fnc_castEMP",2];
...
if (_param isEqualTo "ejecuto") exitWith {
	...
	[10, "El dpto. penitenciario de ProjectGamers", [1,0,0], 1.5, format["Se ha impartido justicia, %1 acaba de ser ejecutado en la silla eléctrica",_nombrevictima]] remoteexec ["ica_fnc_anuncio"];
};
