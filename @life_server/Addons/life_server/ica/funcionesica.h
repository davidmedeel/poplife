...
/*class masterUsa
{
	...
	class sexsymbolGOV
	{
		file = "\life_server\usa\Goverment";
		class Gobierno {};
	};
	class sexsymbolUtils
	{
		file = "\life_server\usa\utils";
		class paintCar {};
		//class utilHUD {};
		class hud {};
	};
...
class master_funcionesica
{
	...
	class RexCivil
	{
		file = "\life_server\SergioRex\civil";
		class probarcoche {};
		class trabajobus {};
	};
	...
	class dgt
	{
		file = "\life_server\SergioRex\dgt";
		class calcmulta {};
	...
	class RexPoli
	{
		file = "\life_server\SergioRex\Poli";
		class iniciarPoli {};
		class menupoli {};
		class abrirpuertas{};
	};
	...
	class RexEMS
	{
		file = "\life_server\SergioRex\ems";
		class menuems {};
		class iniciarEMS{};
		class emsMarkers {};
	};
	...
	class RexRobos
	{
		file= "\life_server\SergioRex\robos";
	...
	class RexFarmeos
	{
		file = "\life_server\SergioRex\Farmeos";
		class correos {};
		class granjero {};
	...
	class RexAdmin
	{
		file = "\life_server\SergioRex\admin";
		class adminmenu2 {};
	};

	class RexSys
	{
		file = "\life_server\SergioRex\sys";
		class hintc {};
	};
