...
compileFinal "
	...
	[pop_atmdin,pop_din,owner player,player] remoteexec [""life_fnc_admininfo"",_ret];
";
...
private[""_msg"",""_to""];
	...
	[_msg,name player,5] remoteexec [""TON_fnc_clientMessage"",independent];
...
private[""_msg"",""_to""];
	...
	[_msg, name player,6] remoteexec [""clientMessage"",op];
	[] call life_fnc_cellphone;
...
compileFinal "
	...
	[_msg,name player,1] remoteexec [""TON_fnc_clientMessage""];
	[] call life_fnc_cellphone;
...
compileFinal "
	...
	[_msg, name player,2] remoteexec [""TON_fnc_clientMessage""];
	[] call life_fnc_cellphone;
	hint format[""You sent %1 a message: %2"",_to,_msg];
	ctrlShow[3017,true];
";
...
compileFinal "
	...
	[_msg, name player,4] remoteexec [""TON_fnc_clientMessage""];
	[] call life_fnc_cellphone;
