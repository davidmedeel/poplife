...
if ((player distance [8530.69,6628.44,-0.0585136]) < 50) exitwith {}; // piscina en garaje to fea de juan tovar...
	...
	sleep 1;
	_corcho = createVehicle ["Rex_Corcho",_pos, [], 0, "CAN_COLLIDE"];
