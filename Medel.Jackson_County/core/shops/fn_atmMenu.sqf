...
lbClear _units;
_text ctrlSetStructuredText parseText format["<img size='1.7' image='\medel_fotos\icons\bank.paa'/>  %1 €<br/><img size='1.6' image='\medel_fotos\icons\money.paa'/>  %2 €",[medel_atmdin] call life_fnc_numberText,[medel_din] call life_fnc_numberText];
