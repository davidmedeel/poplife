...
{
//	case independent: {[[player,0,"\medel_fotos\textures\medic_uniform.jpg"],"life_fnc_setTexture",true,false] call life_fnc_MP;};
	case independent: {[player,0,"\medel_fotos\textures\medic_uniform.jpg"] remoteexec ["life_fnc_setTexture"]; };
};
