...
if(medel_din > 0) then
{
	...
	{
		medel_din = 0;
		//[[medel_din],"life_fnc_robReceive",_robber,false] call life_fnc_MP;
		[medel_din] remoteexec ["life_fnc_robReceive",_robber];
	} else {
	//[[medel_din],"life_fnc_robReceive",_robber,false] call life_fnc_MP;
	[medel_din] remoteexec ["life_fnc_robReceive",_robber];
	...
	//[[1,"STR_NOTF_Robbed",true,[_robber getVariable["realname",name _robber],profileName,[medel_din] call life_fnc_numberText]],"life_fnc_broadcast",nil,false] call life_fnc_MP;
	[1,"STR_NOTF_Robbed",true,[_robber getVariable["realname",name _robber],profileName,[medel_din] call life_fnc_numberText]] remoteexec ["life_fnc_broadcast",nil];
	medel_din = 0;
	};
}
	else
