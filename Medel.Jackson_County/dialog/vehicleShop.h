class Life_Vehicle_Shop_v2
{
	...
	class controlsBackground
	{
		...
		class medelProbarVehiculo : life_RscButtonMenu
		{
			idc = 2309;
			text = "Probar veh";
			colorBackground[] = {0.07,0.46,0,1};	
			onButtonClick = "[] spawn ica_fnc_probarcoche;";
			x = 0.40 + (6.25 / 40) + (1 / 250 / (safezoneW / safezoneH));
			y = 0.9 - (1 / 25);
			w = (6.25 / 40);
			h = (1 / 25);
		};
		class ColorCustom : life_RscButtonMenu
		{
			idc = 2310;
			text = "Pintar VEH";
			//colorBackground[] = {0.07,0.46,0,1};	
			onButtonClick = "closedialog 0;createDialog ""PaintCaring"";";
			x = 0.60 + (6.25 / 40) + (1 / 250 / (safezoneW / safezoneH));
			y = 0.9 - (1 / 25);
			w = (6.25 / 40);
			h = (1 / 25);
		};
