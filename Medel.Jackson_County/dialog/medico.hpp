...
class medico
{
	...
	class controls {
		class cabeza: Life_RscPicture	{
			idc = 7021;
			text = "\medel_fotos\icons\medica\cab.paa";
			x = 0.055;
			y = 0.2;
			w = 0.4275;
			h = 0.6;
		...
		class pecho: Life_RscPicture	{
			idc = 7022;
			text = "\medel_fotos\icons\medica\pec.paa";
			x = 0.055;
			y = 0.2;
			w = 0.4275;
			h = 0.6;
		...
		class brazos: Life_RscPicture	{
			idc = 7023;
			text = "\medel_fotos\icons\medica\bra.paa";
			x = 0.055;
			y = 0.2;
			w = 0.4275;
			h = 0.6;
		...
		class piernas: Life_RscPicture	{
			idc = 7024;
			text = "\medel_fotos\icons\medica\pie.paa";
			x = 0.055;
			y = 0.2;
			w = 0.4275;
			h = 0.6;
