...
[1,format["%1 was added to the wanted list.",name _unit,_amount,getPlayerUID _unit]] remoteexec ["life_fnc_broadcast"];

//[[getPlayerUID _unit,name _unit,_amount],"life_fnc_wantedAdd",false,false] call life_fnc_MP;
[getPlayerUID _unit,name _unit,_amount] remoteexec ["life_fnc_wantedAdd",2];