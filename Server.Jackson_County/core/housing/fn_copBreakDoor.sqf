...
[2,"STR_House_Raid_NOTF",true,[(_house getVariable "house_owner") select 1]] remoteexec ["life_fnc_broadcast"];

while {true} do
{
	if(animationState player != "AinvPknlMstpSnonWnonDnon_medic_1") then {
		//[[player,"AinvPknlMstpSnonWnonDnon_medic_1"],"life_fnc_animSync",true,false] call life_fnc_MP;
		[player,"AinvPknlMstpSnonWnonDnon_medic_1"] remoteexec ["life_fnc_animSync"];
