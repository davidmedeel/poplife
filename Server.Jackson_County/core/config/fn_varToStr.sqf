...
switch (_var) do
{
	...
	case "license_civ_policiaon": {(localize "STR_License_PoliOn")};
	case "license_civ_EMSON": {(localize "STR_License_EMSON")};
	case "license_civ_EMSON": {(localize "STR_License_EMSON")};
	case "license_cop_especialidad": {(localize "STR_License_Especialidad")};
