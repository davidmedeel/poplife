...
switch (_mode) do {
	case 0: {
		switch (_type) do {
			...
			case "PoliOn": {_var = "license_civ_policiaon"};	// Rex poli
			case "EMSON": {_var = "license_civ_EMSON"};	// Rex poli
			case "Especialidad": {_var = "license_cop_especialidad"};	// Rex poli
	...
	case 1: {
		switch (_type) do {
			...
			case "license_civ_policiaon": {_var = "PoliOn"};	// Drivers License cost
			case "license_civ_EMSON": {_var = "EMSON"};	// Drivers License cost
			case "license_cop_especialidad": {_var = "Especialidad"};	// Drivers License cost
