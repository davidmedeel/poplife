...
{
//	case independent: {[[player,0,"\Rex_Fotos\textures\medic_uniform.jpg"],"life_fnc_setTexture",true,false] call life_fnc_MP;};
	case independent: {[player,0,"\Rex_Fotos\textures\medic_uniform.jpg"] remoteexec ["life_fnc_setTexture"]; };
};
