...
["Aviso la Purga  va comenzar.  Todos los policías y servicio de emergencias quedan desactivados, vuelvan inmediatamente a sus casas. La unica norma activa es no matar en zonas de EMS","Gobierno de Sahrani",6] remoteexec ["TON_fnc_clientMessage",-2];

//["purge","playSound", true, true, true] call bis_fnc_MP;
["purge"] remoteexec ["playSound",-2];
...
[["COMIENZA LA PURGA HASTA QUE LAS LUCES SE APAGUEN"]] remoteexec ["BIS_fnc_typeText",-2];
...
while {true} do {
	...
	["La purga está activa hasta que se apaguen las luces","Gobierno de Sahrani",6] remoteexec ["TON_fnc_clientMessage",civilian];
	sleep 300;
};
