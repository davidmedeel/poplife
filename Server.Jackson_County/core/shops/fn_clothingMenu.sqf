...
if((_this select 3) in ["cop","brucecop"] and !license_civ_policiaon) exitWith {hint localize "STR_Shop_NotaCop"; closeDialog 0;};
if((_this select 3) == "ems" && !license_civ_EMSON) exitWith {hint "No eres un EMS"; closeDialog 0;};
