...
lbClear _units;
_text ctrlSetStructuredText parseText format["<img size='1.7' image='\Rex_Fotos\icons\bank.paa'/>  %1 €<br/><img size='1.6' image='\Rex_Fotos\icons\money.paa'/>  %2 €",[pop_atmdin] call life_fnc_numberText,[pop_din] call life_fnc_numberText];
